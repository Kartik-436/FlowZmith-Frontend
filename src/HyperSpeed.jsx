...
export const hyperspeedPresets = {
    one: {
        ...
        carLightsLength: [450 * 0.03, 450 * 0.2],
        carLightsRadius: [0.05, 0.14],
        carWidthPercentage: [0.8, 0.5],
        carShiftX: [-0.5, 0.8],
       ...
       colors: {
            ...
            shoulderLines: 0x00A08C, // A nice teal for the road lines
            brokenLines: 0x00A08C,   // A nice teal for the road lines
            leftCars: [0x00F5D4, 0x40E0D0, 0x00B39F], // An array of vibrant teal/turquoise colors
            rightCars: [0x9DE0AD, 0x3CB371, 0x2E8B57], // An array of complementary green colors
            sticks: 0x00F5D4 // A bright, primary teal for the side light sticks
            // --- MODIFIED LINES END ---
        }
    },
    two: {
